    ...
    public void simpleInitApp() {
     ...
     private void createStartScreen() {
         nifty.addScreen("start", new ScreenBuilder("start") {{
             controller(new com.github.migi_1.ContextApp.Screens.MainMenuAndroidFunctions());
     ...
     private void createJoinScreen() {
         nifty.addScreen("join", new ScreenBuilder("join"){{
             controller(new MainMenuAndroidFunctions());
      ...
      */
     private ButtonBuilder createButtonControl(final String buttonId, final String buttonLabel, final String childLayout, final String align, final String valign, 
      ...
      */
     private PanelBuilder panelWithText(final String id, final String childLayout, final String align, final String valign, 
                final String color, final String height, final String width, final TextBuilder txt) {
      ...
      */
     private PanelBuilder panelWithControl(final String id, final String childLayout, final String align, final String valign, 
                                    final String color, final String width, final String heigth, final ControlBuilder con) {
         return new PanelBuilder(id) {{
             switch (childLayout) {
                 case "none" : break;
                 case "center" :
