 ...
 * @author Nils
 */
public class RotateBugSprayActivity_BR extends Activity implements RotateBugSprayActivities {
    private TextView spray_br;
    private Button bug_br;
    ...
    private float x1, x2, y1, y2, deltaHorizontal, deltaVertical;
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            spray_br = (TextView) findViewById(R.id.eventBug_spray_fr);
            spray_br.setVisibility(View.GONE);
            bug_br = (Button) findViewById(R.id.eventBug_bug_fr);
            bug_br.setVisibility(View.VISIBLE);
            
            bug_br.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Log.d("rotate", "FRONT RIGHT");
                    if(spray_br.getVisibility() == View.VISIBLE && bug_br.getVisibility() == View.VISIBLE) {
                        finish();
                    }
                }
            });
