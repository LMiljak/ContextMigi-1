...
public class TestInputHandler {
    ...
    public void initInputTest() {
        ...
        Mockito.verify(inputManager, Mockito.times(11)).addMapping(Mockito.anyString(), Mockito.any());
        //Verify all listeners are bound.
        Mockito.verify(inputManager, Mockito.times(11)).addListener(Mockito.any(), Mockito.anyString());
    }
